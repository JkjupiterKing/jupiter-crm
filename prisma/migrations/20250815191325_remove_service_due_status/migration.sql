/*
  ...
  - You are about to drop the column `serviceDueStatus` on the `ServiceJob` table. All the data in the column will be lost.
...
INSERT INTO "new_ServiceJob" ("billedAmount", "createdAt", "customerId", "customerProductId", "engineerId", "id", "jobType", "notes", "problemDescription", "resolutionNotes", "saleId", "serviceDueDate", "serviceVisitStatus", "updatedAt", "visitScheduledDate", "warrantyStatus") SELECT "billedAmount", "createdAt", "customerId", "customerProductId", "engineerId", "id", "jobType", "notes", "problemDescription", "resolutionNotes", "saleId", "serviceDueDate", "serviceVisitStatus", "updatedAt", "visitScheduledDate", "warrantyStatus" FROM "ServiceJob";

/*
  ...
  - You are about to drop the column `scheduledDate` on the `ServiceJob` table. All the data in the column will be lost.
...
INSERT INTO "new_ServiceJob" ("billedAmount", "createdAt", "customerId", "customerProductId", "engineerId", "id", "jobType", "notes", "problemDescription", "resolutionNotes", "saleId", "serviceDueDate", "updatedAt", "warrantyStatus") SELECT "billedAmount", "createdAt", "customerId", "customerProductId", "engineerId", "id", "jobType", "notes", "problemDescription", "resolutionNotes", "saleId", "serviceDueDate", "updatedAt", "warrantyStatus" FROM "ServiceJob";
